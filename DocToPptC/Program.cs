...
namespace DocToPptC
{
    internal class Program
    {
        private static void Main(string[] args)
        {
           ...
           OfficeEx.DocxF = @"D:\DocToPPTС\Doc.docx";
           OfficeEx.PptxF = @"D:\DocToPPTС\6.Картa ЧС.pptx";
           OfficeEx.ExcelF = @"D:\DocToPPTС\12. Анализ ФП и ТП РСЧС приложение 1.xlsx";
           ...
           /*Вводная параграф*/
            ...
            OfficeEx.Txt = OfficeEx.DocGetPar(OfficeEx.DocxF, 5, 0, 0);
            OfficeEx.PptxGetPar(OfficeEx.PptxF, 0, 1, 0, 0);
            ...
            OfficeEx.PptxGetPar(OfficeEx.PptxF, 0, 0, 1, 0);

            /*второй параграф параграф вывод*/
            OfficeEx.Txt = str[6] + "." + str[7] + "." + " " + str[8];
            OfficeEx.PptxGetPar(OfficeEx.PptxF, 0, 0, 2, 0);

            /*температура*/
            OfficeEx.Txt = OfficeEx.DocGetPar(OfficeEx.DocxF, 6, 0, 0);
            int parag2 = OfficeEx.SearchString("температура");
            OfficeEx.Txt = OfficeEx.ReadWordIp(parag2 + 1);
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 1, 1, 1, 0);
...
//            str.Add(OfficeEx.ReadWordIp(9));/*10*/
            ...
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 1, 2, 1, 0); 
            ...
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 1, 3, 1, 0);
            ...
            OfficeEx.Txt = str[13];
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 3, 1, 1, 0);
            ...
            OfficeEx.Txt = str[14];
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 3, 2, 1, 0);
            ...
            OfficeEx.Txt = str[15];
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 3, 3, 1, 0);
            

              /*От МЧС л/с, чел. */
            OfficeEx.Txt = OfficeEx.ExcelGetVal(OfficeEx.ExcelF, 0, 0, 8, 2);
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 4, 3, 1, 0);

            /*От МЧС тех.ед*/
            OfficeEx.Txt = OfficeEx.ExcelGetVal(OfficeEx.ExcelF, 0, 0, 8, 3);
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 4, 3, 2, 0);

            /*Всего л/с, чел.*/
            OfficeEx.Txt = OfficeEx.ExcelGetVal(OfficeEx.ExcelF, 0, 0, 20, 2);
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 4, 4, 1, 0);

            /*Всего тех.ед*/
            OfficeEx.Txt = OfficeEx.ExcelGetVal(OfficeEx.ExcelF, 0, 0, 20, 3);
            OfficeEx.PptxGetTab(OfficeEx.PptxF, 0, 4, 4, 2, 0);
